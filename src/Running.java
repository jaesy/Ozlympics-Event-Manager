...
public class Running extends Sports
{
    ...
    private final String gameType = "Running"; //Used to print Sports Type    
    ...
    //Constructors
	public Running(String x)
	{
		super(x);
	}

	public Running(String x, String y)
	{
		super(x,y);	
	}
    ...
    {
    	System.out.println("testMethod Overriden");
    }
